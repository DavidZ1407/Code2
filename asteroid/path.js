...
(function (AsteroidsInheritance) {
    AsteroidsInheritance.shapesAsteroids = [
        [
    ...
    function createPaths() {
        AsteroidsInheritance.asteroidPaths = createAsteroidPaths(AsteroidsInheritance.shapesAsteroids);
        AsteroidsInheritance.ufoPath = createUfoPath();
    }
    AsteroidsInheritance.createPaths = createPaths;
