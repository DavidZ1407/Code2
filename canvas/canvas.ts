namespace CanvasAnimation {
    ...
    function updateCircle(circle: AnimatedCircle): void {
    ...
    function renderCircle(circle: AnimatedCircle): void {
    ...
    function hexToRGBArray(hexColor: string): [number, number, number] {
    ...
    function drawCurvedPattern(x: number, y: number, radius: number, rotation: number, color: string): void {
    ...
    function drawLinePattern(x: number, y: number, radius: number, rotation: number, color: string): void {
